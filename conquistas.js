// ===========================================
// CONQUISTAS.JS V1 (COM SISTEMA DE ÁUDIO WEB API) 🏆🔊
// G2 GARAGEM
// ===========================================
...
function desbloquearConquista(id){
    ...
    // Toca o som triunfante de conquista desbloqueada! 🏆
    tocarSomConquista();
...
function abrirConquistas(){
    ...
    conquistas.forEach(function(c){
        ...
        <div class="resumo-compra">
            ...
            <small>💰 Recompensa: R$ ${c.recompensa.toLocaleString("pt-BR")}</small>
        </div>
        `;
    });
...
function desbloquearConquistaEspecial(id){
    ...
    // Toca o som triunfante de conquista especial! 🌟
    tocarSomConquista();
...
// ===========================
// EFEITO SONORO DE CONQUISTA (WEB AUDIO API)
// ===========================
function tocarSomConquista() {
    if (typeof audioCtx !== "undefined" && audioCtx) {
        try {
            ...
            // Sequência de notas ascendentes (acorde triunfante)
            ...
            notas.forEach((freq, index) => {
                ...
                let tempoInicio = audioCtx.currentTime + (index * 0.08);
                osc.start(tempoInicio);
                osc.stop(tempoInicio + 0.25);
            });
        } catch (e) {}
    }
}
